  ...
  return (
    ...
    >
      <ScrollAnimationWrapper>
          <motion.div
            ...
            <div className="flex w-full">
              ...
              animate={{ rotate: -360 }} // Rotate from right to left
      ...
      <div className="relative w-full flex">
        <ScrollAnimationWrapper
          className="rounded-lg w-full grid grid-flow-row sm:grid-flow-row grid-cols-1 sm:grid-cols-3 py-9 divide-y-2 sm:divide-y-0 sm:divide-x-2 divide-gray-100 bg-black-600 z-10">
