        ...
        <div className="flex flex-col w-full">
          ...
          <div className="grid grid-flow-row sm:grid-flow-col grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-12 py-8 lg:py-12 px-6 sm:px-0 lg:px-6">
            ...
            <ScrollAnimationWrapper className="flex justify-center">
              ...
              <div className="flex flex-col w-full justify-center mb-8 flex-none mt-12">
                <p className="text-2xl text-white-500 text-center mb-4 ">
                  $9 <span className="text-white-500">/ mo</span>
                </p>
                <ButtonOutline>Select</ButtonOutline>
              </div>
              </motion.div>
            ...
            <ScrollAnimationWrapper className="flex justify-center">
              ...
              <div className="flex flex-col w-full justify-center mb-8 flex-none mt-12">
                <p className="text-2xl text-white-500 text-center mb-4 ">
                  $12 <span className="text-white-500">/ mo</span>
                </p>
        ...
        <div className="flex flex-col w-full my-16" id="testimoni">
          ...
          <ScrollAnimationWrapper className="relative w-full mt-16">
            <motion.div variants={scrollAnimation} custom={{duration: 3}}>
              <div className="absolute rounded-xl  py-8 sm:py-14 px-6 sm:px-12 lg:px-16 w-full flex flex-col sm:flex-row justify-between items-center z-10 bg-black-600">
